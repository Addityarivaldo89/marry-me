...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Playball&family=Prata&display=swap" rel="stylesheet">
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <link rel="icon" href="data:;base64,iVBORwOKGO=" />
    <link rel="stylesheet" type="text/css" href="assets/vendor/animate/animate.css">
    <link rel="stylesheet" type="text/css" href="assets/vendor/select2/select2.min.css">
    <link rel="stylesheet" href="assets/css/astronomy.css">
            ...
            <div class="container py-0">
                <div class="display1">
                    <div class="py-4">
                        ...
                        <h1 class="display1-title" data-aos="zoom-out-up" data-aos-delay="1000">Haycal & Shafa</h1>
                        ...
                        <div class="container">
                            <div class="card-deck">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="assets/img/as cowo.jpg" alt="Card image cap" style="width:150px; align-item:center" data-aos="zoom-out-right" data-aos-delay="800">
                                ...
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top" src="assets/img/as cewe.jpeg" alt="Card image cap" style="width:150px; align-item:center" data-aos="zoom-out-left" data-aos-delay="800">
                                    <div class="card-body" data-aos="fade-up" data-aos-duration="1000">
    ...
    <section class="section4">
        <div class="website-block hero d-flex position-relative text-white text-center py-10 align-items-center">
            <div class="container py-0">
                <div class="display4">
                    <div class="container">
                        <div class="display4-title" data-aos="fade-down">
