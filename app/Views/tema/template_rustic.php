    ...
    <section class="section1">
        <div class="website-block hero d-flex position-relative text-white text-center py-10 align-items-center">
            <div class="container py-0">
                <div class="display1">
                    <div class="py-4">
                        <h3 class="display1-sub-title" data-aos="fade-down">20 . 01 . 2025</h3>
                        <h1 class="display1-title" data-aos="zoom-in">Ikram & Rani</h1>
                        <h3 class="display1-sub-title" data-aos="fade-up">The Wedding</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="container">
                            <div class="card-deck">
                                <div class="card mb-4 location-akad">
                                    <iframe class="card-maps-top img-fluid" width="100%" height="100%" src="https://maps.google.com/maps?q=jakart&t=&z=11&ie=UTF8&iwloc=&output=embed"></iframe>
                                    <div class="card-body">
                                        <h4 class="card-title-loaction" data-aos="fade-down">Akad Nikah</h4>
                                        <p class="card-text-location" data-aos="zoom-in"> Jl. Gatot Subroto No.Kav. 37, RT.6/RW.3, Kuningan, Kuningan Tim.,
